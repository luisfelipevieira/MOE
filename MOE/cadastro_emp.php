        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    <h3 class="title has-text-grey">Cadastro - Empregador</h3>
                    ...
                    <div class="box">
                        <form action="cadastrar_emp.php" method="POST">
                            <div class="field">
                                <div class="control">
                                    <input name="nome_empresa" type="text" class="input is-large" placeholder="Nome da empresa" autofocus>
                                </div>
                            </div>
                            <div class="field">
                                <div class="control">
                            ...
                            <div class="field">
                                <div class="control">
                                    <input name="nome_pessoa" type="text" class="input is-large" placeholder="Nome do responsável" autofocus>
                                </div>
                            </div>
                            <div class="field">
                                <div class="control">
                            ...
                            <p><a href="index_emp.php">Fazer login</a></p>
